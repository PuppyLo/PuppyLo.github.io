ymaps.ready(function () {
    ...
    myMap.geoObjects.add(new ymaps.Placemark([55.683815, 37.583827], {
        object: 'Mona Tobacco на Академической',
        balloonContent:
            `<strong>Mona Tobacco</strong></br>
            <strong>Новочерёмушкинская улица, 17</strong></br>
            <strong>Режим работы: </strong>понедельник - воскресенье 10:00 - 22:00</br>
            <a href="https://yandex.ru/maps/?rtext=~55.683815, 37.583827" target="_blank">Построить маршрут в Яндекс.Карты</a>`
    }, {
        iconLayout: 'default#image',
        iconImageHref: 'https://upload.wikimedia.org/wikipedia/commons/5/58/Simpleicons_Places_placeholder-tool.svg',
        iconImageSize: [35, 35],
